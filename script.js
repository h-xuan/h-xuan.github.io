...
// dark mode script //
const moonPath = "M16 27.5C16 42.6878 27.5 54.5 27.5 55C12.3122 55 0 42.6878 0 27.5C0 12.3122 12.3122 0 27.5 0C27.5 0 16 12.3122 16 27.5Z";
...
darkMode.addEventListener('click', () => {
	...
	.add({
		targets: "#main",
		filter: toggle ? "grayscale(0%) brightness(100%)" : "grayscale(80%) brightness(40%)"
	}, "-= 1200")
	.add({
		targets: "#content",
	...
	.add({
		targets: "#house",
		filter: toggle ? "sepia(50%) grayscale(0%) brightness(100%)" : "grayscale(80%) brightness(40%)"
	}, "-= 1200")
	.add({
		targets: "#window",
...
for(let i = 0; i < links.length; i++) {
  links[i].addEventListener("click", function() {
  	...
  	document.getElementById("canvas").style.height = "20%";
